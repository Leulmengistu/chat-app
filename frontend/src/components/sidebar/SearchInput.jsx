...
function SearchInput() {
  ...
  return (
    <form onSubmit={handleSubmit} className='flex items-center gap-1'>
        <input value={search} onChange={e=>setSearch(e.target.value)} placeholder='Search' type='text' className="text-white bg-gray-700 input input-bordered rounded-full" />
